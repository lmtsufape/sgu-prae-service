...
public class DadosBancariosController {
    ...
    public ResponseEntity<DadosBancariosResponse> criarDadosBancarios(@PathVariable UUID idEstudante, @RequestBody DadosBancariosRequest dadosBancariosRequest) {
